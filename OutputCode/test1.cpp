...
glNewList(1, GL_COMPILE);  // create chair list
glPushMatrix();
glColor4ub(0.00, 0.00, 0.00, 255.00);
glTranslated(0.00, 1.00, 0.00);
glRotated(0.00, 1, 0, 0);
glRotated(0.00, 0, 1, 0);
glRotated(0.00, 0, 0, 1);
glScaled(1.00, 0.20, 1.00);
glutSolidSphere(1, 50, 50);
glPopMatrix();

glPushMatrix();
glColor4ub(100.00, 100.00, 100.00, 255.00);
glTranslated(-0.60, 0.50, -0.60);
glRotated(0.00, 1, 0, 0);
glRotated(0.00, 0, 1, 0);
glRotated(0.00, 0, 0, 1);
glScaled(0.10, 1.00, 0.10);
glutSolidCube(1);
glPopMatrix();
...
glPushMatrix();
glColor4ub(0.00, 0.00, 0.00, 255.00);
glTranslated(0.60, 2.50, -0.00);
glRotated(0.00, 1, 0, 0);
glRotated(0.00, 0, 1, 0);
glRotated(0.00, 0, 0, 1);
glScaled(0.20, 1.00, 1.00);
glutSolidSphere(1, 50, 50);
glPopMatrix();
...
glRotated(0.00, 0, 0, 1);
glScaled(1.00, 1.00, 1.00);
glCallList(0);  // call chair list
glPopMatrix();

glPushMatrix();
glColor4ub(0.00, 0.00, 0.00, 255.00);
glTranslated(-18.00, 0.00, 0.00);
glRotated(0.00, 1, 0, 0);
glRotated(0.00, 0, 1, 0);
glRotated(0.00, 0, 0, 1);
glScaled(1.00, 1.00, 1.00);
