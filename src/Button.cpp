...
void Button::display() {
    ...
    glVertex2f((x + 20 + (this->text.length() * 9.0) - 750.0) / 750.0, (y - 400) / 400.0);
    glVertex2f((x + 20 + (this->text.length() * 9.0) - 750.0) / 750.0, (y + 30 - 400) / 400.0);
    ...
    renderBitmapText((x + 10 - 750) / 750.0, (y + 10 - 400) / 400.0, text.c_str(), GLUT_BITMAP_HELVETICA_18);
}
